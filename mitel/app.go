...
import (
	...
	"github.com/weareplanet/ifcv5-drivers/mitel/automate/datachange"
	"github.com/weareplanet/ifcv5-drivers/mitel/automate/dbsync"
	"github.com/weareplanet/ifcv5-drivers/mitel/automate/linkcontrol"
	"github.com/weareplanet/ifcv5-drivers/mitel/automate/request"

	"github.com/weareplanet/ifcv5-main/ifc/automate/inhousesync"

	drv "github.com/weareplanet/ifcv5-drivers/mitel/dispatcher"
...
func registerTemplates(parser *analyser.GenericProtocol) {
	...
	// incoming
	parser.RegisterIncomingTemplate(template.PacketSwapEnquiry, &template.TplSwapEnquiry{})
	parser.RegisterIncomingTemplate(template.PacketRoomStatus, &template.TplRoomStatus{})
	parser.RegisterIncomingTemplate(template.PacketCallCounter, &template.TplCallCounter{})
	...
	// outgoing
	parser.RegisterOutgoingTemplate(template.PacketAlive, &template.TplAlive{})
	...
	parser.RegisterOutgoingTemplate(template.PacketChangeName, &template.TplChangeName{})
	parser.RegisterOutgoingTemplate(template.PacketMessageLamp, &template.TplMessageLamp{})
	parser.RegisterOutgoingTemplate(template.PacketSetRestriction, &template.TplSetRestriction{})
	parser.RegisterOutgoingTemplate(template.PacketWakeupSet, &template.TplWakeup{})
	parser.RegisterOutgoingTemplate(template.PacketWakeupClear, &template.TplWakeup{})
	parser.RegisterOutgoingTemplate(template.PacketSwapStart, &template.TplSwapStart{})
	parser.RegisterOutgoingTemplate(template.PacketSwapEnd, &template.TplSwapEnd{})
