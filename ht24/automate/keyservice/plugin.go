...
import (
	...
	ht24 "github.com/weareplanet/ifcv5-drivers/ht24/dispatcher"
...
func New(parent *ht24.Dispatcher) *Plugin {
	return &Plugin{driver: parent}
}

const (
	retryDelay       = ht24.RetryDelay
	packetTimeout    = ht24.PacketTimeout
	nextActionDelay  = ht24.NextActionDelay
	maxError         = maxRefusion + 1
	maxNetworkError  = ht24.MaxNetworkError
	keyAnswerTimeout = ht24.KeyAnswerTimeout
