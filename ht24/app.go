...
import (
	...
	"github.com/weareplanet/ifcv5-drivers/ht24/automate/keyservice"
	"github.com/weareplanet/ifcv5-drivers/ht24/automate/linkcontrol"
	"github.com/weareplanet/ifcv5-drivers/ht24/template"

	drv "github.com/weareplanet/ifcv5-drivers/ht24/dispatcher"
...
func registerTemplates(parser *analyser.GenericProtocol) {
	...
	parser.RegisterIncomingTemplate(template.PacketCodeCardAnswer, &template.TplAnswerPositivePacket{})
	parser.RegisterIncomingTemplate(template.PacketCodeCardAnswer, &template.TplAnswerPositiveAdvancedPacket{})

	parser.RegisterIncomingTemplate(template.PacketError, &template.TplAnswerSimpleErrorPacket{})
	parser.RegisterIncomingTemplate(template.PacketError, &template.TplAnswerAdvancedErrorPacket{})
	...
	parser.RegisterOutgoingTemplate(template.PacketCodeCard, &template.TplCodeCardPacket{})
	parser.RegisterOutgoingTemplate(template.PacketCodeCard14, &template.TplCodeCardPacket14{})
	parser.RegisterOutgoingTemplate(template.PacketCodeCard15, &template.TplCodeCardPacket15{})
	parser.RegisterOutgoingTemplate(template.PacketCheckout, &template.TplCheckoutPacket{})
