...
import (
	...
	ilco "github.com/weareplanet/ifcv5-drivers/ilco/dispatcher"
...
func New(parent *ilco.Dispatcher) *Plugin {
	return &Plugin{driver: parent}
}

const (
	retryDelay       = ilco.RetryDelay
	packetTimeout    = ilco.PacketTimeout
	nextActionDelay  = ilco.NextActionDelay
	maxError         = maxRefusion + 1
	maxNetworkError  = ilco.MaxNetworkError
	keyAnswerTimeout = ilco.KeyAnswerTimeout
	...
	waitForAnswer = automatestate.WaitForAnswer
	sendSOF       = automatestate.Delay
