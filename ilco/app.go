...
import (
	...
	"github.com/weareplanet/ifcv5-drivers/ilco/automate/keyservice"
	"github.com/weareplanet/ifcv5-drivers/ilco/automate/linkcontrol"
	"github.com/weareplanet/ifcv5-drivers/ilco/template"

	drv "github.com/weareplanet/ifcv5-drivers/ilco/dispatcher"
...
func registerTemplates(parser *analyser.GenericProtocol) {
	...
	parser.RegisterIncomingTemplate(template.PacketSof, &template.TplSOF{})

	parser.RegisterIncomingTemplate(template.PacketCodeCardAnswer, &template.TplAnswerDirectPacket{})
	parser.RegisterIncomingTemplate(template.PacketCodeCardAnswer, &template.TplAnswerGatewayPacket{})
	...
	parser.RegisterOutgoingTemplate(template.PacketSof, &template.TplSOF{})
