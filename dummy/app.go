...
import (
	...
	//"github.com/weareplanet/ifcv5-drivers/dummy/automate/linkcontrol"
	//"github.com/weareplanet/ifcv5-drivers/dummy/automate/datachange"
	// "github.com/weareplanet/ifcv5-drivers/dummy/automate/keyservice"
	// "github.com/weareplanet/ifcv5-drivers/dummy/automate/request"
	...
	drv "github.com/weareplanet/ifcv5-drivers/dummy/dispatcher"
...
func registerTemplates(parser *analyser.GenericProtocol) {
	...
	// incoming
	// HERE WE GO
	// parser.RegisterIncomingTemplate(template.PacketRequest1, &template.TplRequest1Packet{})
	// parser.RegisterIncomingTemplate(template.PacketRequest2, &template.TplRequest2Packet{})
	...
	// outgoing
	// HERE WE GO
	parser.RegisterOutgoingTemplate(template.PacketCheckIn, &template.TplDummyPacket{})
	parser.RegisterOutgoingTemplate(template.PacketCheckOut, &template.TplDummyPacket{})
	parser.RegisterOutgoingTemplate(template.PacketDataChange, &template.TplDummyPacket{})
	parser.RegisterOutgoingTemplate(template.PacketKeyRequest, &template.TplDummyPacket{})
	parser.RegisterOutgoingTemplate(template.PacketKeyDelete, &template.TplDummyPacket{})
