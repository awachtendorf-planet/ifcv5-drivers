...
import (
	...
	"github.com/weareplanet/ifcv5-drivers/callstar/automate/datachange"
	"github.com/weareplanet/ifcv5-drivers/callstar/automate/dbsync"
	"github.com/weareplanet/ifcv5-drivers/callstar/automate/linkcontrol"
	"github.com/weareplanet/ifcv5-drivers/callstar/automate/request"

	"github.com/weareplanet/ifcv5-main/ifc/automate/inhousesync"

	drv "github.com/weareplanet/ifcv5-drivers/callstar/dispatcher"
...
func registerTemplates(parser *analyser.GenericProtocol) {
	...
	// incoming
	parser.RegisterIncomingTemplate(template.PacketRequest, &template.TplRequestPacket{})
	parser.RegisterIncomingTemplate(template.PacketSwapEnquiry, &template.TplSwapRequest{})
	...
	// outgoing
	parser.RegisterOutgoingTemplate(template.PacketCheckIn, &template.TplOutgoing{})
	parser.RegisterOutgoingTemplate(template.PacketCheckOut, &template.TplOutgoing{})
	parser.RegisterOutgoingTemplate(template.PacketDataChange, &template.TplOutgoing{})
	parser.RegisterOutgoingTemplate(template.PacketRoomMove, &template.TplOutgoingMove{})
	parser.RegisterOutgoingTemplate(template.PacketWakeupRequest, &template.TplOutgoing{})
	parser.RegisterOutgoingTemplate(template.PacketWakeupClear, &template.TplOutgoing{})
	parser.RegisterOutgoingTemplate(template.PacketRoomStatus, &template.TplOutgoing{})

	// outgoing swap
	parser.RegisterOutgoingTemplate(template.PacketCheckInSwap, &template.TplOutgoingSwap{})
	parser.RegisterOutgoingTemplate(template.PacketCheckOutSwap, &template.TplOutgoingSwap{})
	parser.RegisterOutgoingTemplate(template.PacketWakeupRequestSwap, &template.TplOutgoingSwap{})
	parser.RegisterOutgoingTemplate(template.PacketWakeupClearSwap, &template.TplOutgoingSwap{})
	parser.RegisterOutgoingTemplate(template.PacketRoomStatusSwap, &template.TplOutgoingSwap{})
