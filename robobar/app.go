...
import (
	...
	"github.com/weareplanet/ifcv5-drivers/robobar/automate/datachange"
	"github.com/weareplanet/ifcv5-drivers/robobar/automate/dbsync"
	"github.com/weareplanet/ifcv5-drivers/robobar/automate/linkcontrol"
	"github.com/weareplanet/ifcv5-drivers/robobar/automate/posting"
	"github.com/weareplanet/ifcv5-drivers/robobar/template"

	"github.com/weareplanet/ifcv5-main/ifc/automate/inhousesync"

	drv "github.com/weareplanet/ifcv5-drivers/robobar/dispatcher"
...
func registerTemplates(parser *analyser.GenericProtocol) {
	...
	// incoming payload
	parser.RegisterIncomingTemplate(template.PacketRestart, &template.TplRestartPacket{})
	parser.RegisterIncomingTemplate(template.PacketResult, &template.TplResultPacket{})
	parser.RegisterIncomingTemplate(template.PacketSale, &template.TplSalePacket{})
	...
	// outgoing payload
	parser.RegisterOutgoingTemplate(template.PacketRestart, &template.TplRestartPacket{})
	parser.RegisterOutgoingTemplate(template.PacketStartup, &template.TplStartupPacket{})
	parser.RegisterOutgoingTemplate(template.PacketUpdate, &template.TplUpdatePacket{})

	parser.RegisterOutgoingTemplate(template.PacketCheckIn, &template.TplChangePacket{})
	parser.RegisterOutgoingTemplate(template.PacketCheckOut, &template.TplChangePacket{})
	parser.RegisterOutgoingTemplate(template.PacketLockBar, &template.TplChangePacket{})
	parser.RegisterOutgoingTemplate(template.PacketUnlockBar, &template.TplChangePacket{})

	parser.RegisterOutgoingTemplate(template.PacketUpdateCheckIn, &template.TplUpdatePacket{})
	parser.RegisterOutgoingTemplate(template.PacketUpdateCheckOut, &template.TplUpdatePacket{})
	parser.RegisterOutgoingTemplate(template.PacketUpdateLockBar, &template.TplUpdatePacket{})
	parser.RegisterOutgoingTemplate(template.PacketUpdateUnlockBar, &template.TplUpdatePacket{})
...
func registerDriverAutomates(parent *drv.Dispatcher) {
	...
	automate = dispatcher.NewAutomate(parent.Dispatcher)
	automate.AddPlugin(posting.New(parent))
