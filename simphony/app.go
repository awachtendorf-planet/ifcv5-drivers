...
import (
	...
	linkcontrol "github.com/weareplanet/ifcv5-drivers/simphony/automate/linkcontrol"
	"github.com/weareplanet/ifcv5-drivers/simphony/automate/request"

	drv "github.com/weareplanet/ifcv5-drivers/simphony/dispatcher"
...
func registerTemplates(parser *analyser.GenericProtocol) {
	...
	// incoming
	parser.RegisterIncomingTemplate(template.PacketNonFrontOfficeCharge, &template.TplSimphonyChargePostingNonFrontOfficeChargePacket{})
	parser.RegisterIncomingTemplate(template.PacketChargePostingSelectedGuest, &template.TplSimphonyChargePostingSelectedGuestPacket{})
	parser.RegisterIncomingTemplate(template.PacketPostingInquiry, &template.TplSimphonyPostingInquiryPacket{})
	parser.RegisterIncomingTemplate(template.PacketCheckFacsimileRequest, &template.TplSimphonyCheckFascimileRequestPacket{})
	parser.RegisterIncomingTemplate(template.PacketPing, &template.Tcp_Ping{})
	parser.RegisterIncomingTemplate(template.PacketHandshake, &template.TplSimphonyHandshakePacket{})
	...
	// outgoing
	// HERE WE GO
	parser.RegisterOutgoingTemplate(template.PacketChargePostingAck, &template.TplSimphonyChargePostingAckPacket{})
	parser.RegisterOutgoingTemplate(template.PacketInquiryResponse, &template.TplSimphonyInquiryResponsePacket{})
	parser.RegisterOutgoingTemplate(template.PacketCheckFacsimileResponse, &template.TplSimphonyCheckFascimileResponsePacket{})
	parser.RegisterOutgoingTemplate(template.PacketPing, &template.Tcp_Ping{})
	parser.RegisterOutgoingTemplate(template.PacketHandshake, &template.TplSimphonyHandshakePacket{})
