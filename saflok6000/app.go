...
import (
	...
	"github.com/weareplanet/ifcv5-drivers/saflok6000/automate/keyservice"
	"github.com/weareplanet/ifcv5-drivers/saflok6000/automate/linkcontrol"

	drv "github.com/weareplanet/ifcv5-drivers/saflok6000/dispatcher"
...
func registerTemplates(parser *analyser.GenericProtocol) {
	...
	// incoming
	parser.RegisterIncomingTemplate(template.PacketAlive, &template.TplSRC_55{})
	parser.RegisterIncomingTemplate(template.PacketBeaconRequest, &template.TplSRC_20_135{})
	parser.RegisterIncomingTemplate(template.PacketSuccess, &template.TplSRC_62_00{})
	parser.RegisterIncomingTemplate(template.PacketError, &template.TplSRC_62_03{})
	parser.RegisterIncomingTemplate(template.PacketError, &template.TplSRC_62_04{})
	parser.RegisterIncomingTemplate(template.PacketError, &template.TplSRC_62_05{})
	...
	// outgoing
	parser.RegisterOutgoingTemplate(template.PacketAlive, &template.TplPFC_10{})
	parser.RegisterOutgoingTemplate(template.PacketKeyRequest, &template.TplPFC_20_00X{})
	parser.RegisterOutgoingTemplate(template.PacketKeyDelete, &template.TplPFC_20_015{})
	parser.RegisterOutgoingTemplate(template.PacketBeaconResponse, &template.TplPFC_62_000_00{})
