...
import (
	...
	"github.com/weareplanet/ifcv5-drivers/xmlpos/automate/linkcontrol"
	"github.com/weareplanet/ifcv5-drivers/xmlpos/automate/request"

	drv "github.com/weareplanet/ifcv5-drivers/xmlpos/dispatcher"
...
func registerTemplates(parser *analyser.GenericProtocol) {
	...
	// incoming
	// HERE WE GO
	parser.RegisterIncomingTemplate(template.PacketFramed, &template.TplFramedPacket{})
	...
	// outgoing
	// HERE WE GO
	parser.RegisterOutgoingTemplate(template.PacketFramed, &template.TplFramedPacket{})
