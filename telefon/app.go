...
import (
	...
	"github.com/weareplanet/ifcv5-drivers/telefon/automate/linkcontrol"
	"github.com/weareplanet/ifcv5-drivers/telefon/automate/request"

	drv "github.com/weareplanet/ifcv5-drivers/telefon/dispatcher"
...
func New(configFile string) (*App, error) {
	...
	dispatcher := drv.NewDispatcher(driver, parser)
