...
import (
	...
	telefon "github.com/weareplanet/ifcv5-drivers/telefon/dispatcher"
	...
	"github.com/weareplanet/ifcv5-drivers/telefon/dispatcher"
)
...
func New(parent *telefon.Dispatcher) *Plugin {
	return &Plugin{driver: parent}
}

const (
	retryDelay      = telefon.RetryDelay
	packetTimeout   = telefon.PacketTimeout
	nextActionDelay = telefon.NextActionDelay
	maxError        = telefon.MaxError
	maxNetworkError = telefon.MaxNetworkError
