...
import (
	...
	//"github.com/weareplanet/ifcv5-drivers/micros/automate/linkcontrol"
	"github.com/weareplanet/ifcv5-drivers/micros/automate/request"
	linkcontrol "github.com/weareplanet/ifcv5-main/ifc/automate/simplelinkcontrol"

	drv "github.com/weareplanet/ifcv5-drivers/micros/dispatcher"
...
func registerTemplates(parser *analyser.GenericProtocol) {
	...
	// incoming
	parser.RegisterIncomingTemplate(template.PacketCFReqM, &template.TplCFReqMPacket{})
	parser.RegisterIncomingTemplate(template.PacketInquiryRequest, &template.TplInquiryRequest16Packet{})
	parser.RegisterIncomingTemplate(template.PacketInquiryRequest, &template.TplInquiryRequest19Packet{})
	parser.RegisterIncomingTemplate(template.PacketOutletChargeRequest, &template.TplOutletChargePosting48M19Packet{})
	parser.RegisterIncomingTemplate(template.PacketOutletChargeRequest, &template.TplOutletChargePosting48M16Packet{})
	parser.RegisterIncomingTemplate(template.PacketOutletChargeRequest, &template.TplOutletChargePosting44M19Packet{})
	parser.RegisterIncomingTemplate(template.PacketOutletChargeRequest, &template.TplOutletChargePosting44M16Packet{})
	parser.RegisterIncomingTemplate(template.PacketOutletChargeRequest, &template.TplOutletChargePosting8M19Packet{})
	parser.RegisterIncomingTemplate(template.PacketOutletChargeRequest, &template.TplOutletChargePosting8M16Packet{})
	parser.RegisterIncomingTemplate(template.PacketOutletChargeRequest, &template.TplOutletChargePosting16M19Packet{})
	parser.RegisterIncomingTemplate(template.PacketOutletChargeRequest, &template.TplOutletChargePosting16M16Packet{})
	parser.RegisterIncomingTemplate(template.PacketOutletChargeRequest, &template.TplOutletChargePosting8M16kPacket{})
	parser.RegisterIncomingTemplate(template.PacketOutletChargeRequest, &template.TplOutletChargePosting8M19kPacket{})
	parser.RegisterIncomingTemplate(template.PacketOutletChargeRequest, &template.TplOutletChargePosting16M16kPacket{})
	parser.RegisterIncomingTemplate(template.PacketOutletChargeRequest, &template.TplOutletChargePosting16M19kPacket{})
	parser.RegisterIncomingTemplate(template.PacketOutletChargeRequest, &template.TplOutletChargePosting48M16kPacket{})
	parser.RegisterIncomingTemplate(template.PacketOutletChargeRequest, &template.TplOutletChargePosting48M19kPacket{})
	parser.RegisterIncomingTemplate(template.PacketOutletChargeRequest, &template.TplOutletChargePosting44M16kPacket{})
	parser.RegisterIncomingTemplate(template.PacketOutletChargeRequest, &template.TplOutletChargePosting44M19kPacket{})
	parser.RegisterIncomingTemplate(template.PacketPing, &template.Tcp_Ping{})
	...
	parser.RegisterIncomingTemplateWithOption(template.PacketGarbage, &template.TplGarbage_Framing_3{}, 1)
	...
	// outgoing
	// HERE WE GO
	parser.RegisterOutgoingTemplate(template.PacketCFRspM, &template.TplCFRspMPacket{})
	parser.RegisterOutgoingTemplate(template.PacketInquiryResponse, &template.TplInquiryResponsePacket{})
	parser.RegisterOutgoingTemplate(template.PacketOutletChargeResponse, &template.TplOutletChargeResponseMPacket{})
	parser.RegisterOutgoingTemplate(template.PacketPing, &template.Tcp_Ping{})
