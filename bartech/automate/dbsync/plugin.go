...
const (
	retryDelay      = bartech.SwapRetryDelay
	packetTimeout   = bartech.PacketTimeout
	nextActionDelay = bartech.NextActionDelay
	maxError        = maxRefusion + 1
	maxNetworkError = bartech.MaxNetworkError
	pmsTimeOut      = bartech.PmsTimeout
	pmsSyncTimeout  = bartech.PmsSyncTimeout
