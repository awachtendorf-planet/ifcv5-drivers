...
import (
	...
	"github.com/weareplanet/ifcv5-drivers/bartech/automate/datachange"
	"github.com/weareplanet/ifcv5-drivers/bartech/automate/linkcontrol"
	"github.com/weareplanet/ifcv5-drivers/bartech/automate/request"

	"github.com/weareplanet/ifcv5-main/ifc/automate/inhousesync"

	drv "github.com/weareplanet/ifcv5-drivers/bartech/dispatcher"
...
func registerTemplates(parser *analyser.GenericProtocol) {
	...
	// incoming
	parser.RegisterIncomingTemplate(1, template.PacketSyncRequest, &template.TplSyncBasic4{})
	parser.RegisterIncomingTemplate(1, template.PacketSyncRequest, &template.TplSyncAdvanced4{})
	parser.RegisterIncomingTemplate(1, template.PacketSyncRequest, &template.TplSyncBasic6{})
	parser.RegisterIncomingTemplate(1, template.PacketSyncRequest, &template.TplSyncAdvanced6{})

	parser.RegisterIncomingTemplate(1, template.PacketRoomStatus, &template.TplRoomStatusBasic4{})
	parser.RegisterIncomingTemplate(1, template.PacketRoomStatus, &template.TplRoomStatusAdvanced4{})
	parser.RegisterIncomingTemplate(1, template.PacketRoomStatus, &template.TplRoomStatusBasic6{})
	parser.RegisterIncomingTemplate(1, template.PacketRoomStatus, &template.TplRoomStatusAdvanced6{})

	parser.RegisterIncomingTemplate(1, template.PacketInvoice, &template.TplInvoiceBasic4{})
	parser.RegisterIncomingTemplate(1, template.PacketInvoice, &template.TplInvoiceAdvanced4{})
	parser.RegisterIncomingTemplate(1, template.PacketInvoice, &template.TplInvoiceBasic6{})
	parser.RegisterIncomingTemplate(1, template.PacketInvoice, &template.TplInvoiceAdvanced6{})

	// incoming undocumented opera bullshit
	parser.RegisterIncomingTemplate(1, template.PacketInvoice, &template.TplInvoiceUndocumented1_4{})
	parser.RegisterIncomingTemplate(1, template.PacketInvoice, &template.TplInvoiceUndocumented1_6{})
	...
	// outgoing
	parser.RegisterOutgoingTemplate(1, template.PacketCheckIn, &template.TplCheckin{})
	parser.RegisterOutgoingTemplate(1, template.PacketCheckOut, &template.TplCheckout{})
	parser.RegisterOutgoingTemplate(1, template.PacketLockBar, &template.TplLockBar{})
	parser.RegisterOutgoingTemplate(1, template.PacketUnlockBar, &template.TplUnlockBar{})
	parser.RegisterOutgoingTemplate(1, template.PacketEndOfDay, &template.TplEndOfDay{})

	// outgoing undocumented opera bullshit
	parser.RegisterOutgoingTemplate(1, template.PacketCheckInSimple, &template.TplCheckinSimple{})
	parser.RegisterOutgoingTemplate(1, template.PacketCheckInWithoutHappyHour, &template.TplCheckinWithoutHappyHour{})
