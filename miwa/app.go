...
import (
	...
	"github.com/weareplanet/ifcv5-drivers/miwa/automate/keyservice"
	...
	drv "github.com/weareplanet/ifcv5-drivers/miwa/dispatcher"
...
func registerTemplates(parser *analyser.GenericProtocol) {
	...
	// incoming
	// HERE WE GO
	parser.RegisterIncomingTemplate(template.PacketStatusRequestAnswer, &template.TplStatusRequestAnswerPacket{})

	parser.RegisterIncomingTemplate(template.PacketKeyCreateResult, &template.TplCreateKeySuccessPacket{})

	parser.RegisterIncomingTemplate(template.PacketKeyReadAnswer, &template.TplKeyReadResultPacket{})
	...
	// outgoing
	// HERE WE GO
	parser.RegisterOutgoingTemplate(template.PacketKeyCreate, &template.TplCreateKeyPacket{})
	parser.RegisterOutgoingTemplate(template.PacketStatusRequest, &template.TplStatusRequestPacket{})
	parser.RegisterOutgoingTemplate(template.PacketKeyRead, &template.TplKeyReadPacket{})
