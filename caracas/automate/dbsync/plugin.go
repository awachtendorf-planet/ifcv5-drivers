...
const (
	retryDelay      = caracas.RetryDelay
	packetTimeout   = caracas.PacketTimeout
	nextActionDelay = caracas.NextActionDelay
	maxError        = 3
	maxNetworkError = caracas.MaxNetworkError
	pmsTimeOut      = caracas.PmsTimeout
	pmsSyncTimeout  = caracas.PmsSyncTimeout
